...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__firebase_credentials__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_shopping_list_shopping_list_service__ = __webpack_require__(274);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/thassya/IonicShoppingList/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/thassya/IonicShoppingList/src/app/app.html"*/
        }),
...
var FIREBASE_CONFIG = {
    apiKey: "AIzaSyCrMaFXLO9NXAd5B9eC02GyKsGgngIduAM",
    authDomain: "crud-ionic-99ad8.firebaseapp.com",
    databaseURL: "https://crud-ionic-99ad8.firebaseio.com",
    projectId: "crud-ionic-99ad8",
    storageBucket: "crud-ionic-99ad8.appspot.com",
    messagingSenderId: "261777241868"
};
